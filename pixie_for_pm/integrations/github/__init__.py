"""GitHub credential access helpers."""
...
async def get_github_credentials(
    ...
    *,
    ...
    """Return decrypted GitHub OAuth credentials for *discord_server_id*, or ``None``."""
    return await get_credentials(
        discord_server_id, "github", store=store, cipher=cipher
    )
