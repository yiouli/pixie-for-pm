...
agent: <dispatch to pm first> => <pm despatch user researcher to get insights> => <user researcher produces then pass back to PM> => <PM generate hypothesis/general 3 different hypothesis & high level proposal, ask user's feedback>
